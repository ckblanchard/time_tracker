...
describe Client do
  ...
  context "with valid attributes" do
    ...
    it "has a valid phone number with dashes" do
      client.phone_number = "415-555-1234"
      expect(client).to be_valid
    end

    it "has a valid phone number without dashes" do
  ...
  context "with invalid attributes" do
    ...
    it "has an invalid phone number without a numeric phone number" do
      client.phone_number = "415abc1234"
      expect(client).not_to be_valid
    end

    it "has an invalid phone number without a 10-digit phone number" do
